...
* `SCREENCAST - The multiple regression model (7:55) <https://youtu.be/6puregKytuo>`_
* `SCREENCAST - Putting the "least" in ordinary least squares (8:52) <https://youtu.be/eIo2Tb-g2-Y>`_
* `SCREENCAST - What is this R-squared you speak of? (5:01) <https://youtu.be/t-rbKOJ4Hgs>`_
* `SCREENCAST - Predicting college graduation rates: Intro (6:25) <https://youtu.be/xA-3WN_w7uM>`_
* `SCREENCAST - Predicting college graduation rates: Explore and fit model (8:54) <https://youtu.be/edm0R4ozh8o>`_
* `SCREENCAST - Predicting college graduation rates: Assessing model fit (12:35) <https://youtu.be/hiFDIqpwUho>`_
* `SCREENCAST - Predicting college graduation rates: Checking regression assumptions (14:30) <https://youtu.be/BONZTVmAu5k>`_
* `SCREENCAST - Predicting college graduation rates: Using model for prediction (8:45) <https://youtu.be/AAXWotO5deo>`_
* `SCREENCAST - Predicting Major League Baseball wins: The multicollinearity problem (15:47) <https://youtu.be/w4R9AaAqWsQ>`_
* `SCREENCAST - Predicting Major League Baseball wins: Predicting with new new data (6:53) <https://youtu.be/nvb-qMex9Wk>`_
* `SCREENCAST - Using categorical variables in regression models (24:14) <https://youtu.be/YFHlgJhJ0j8>`_
* `SCREENCAST - Modeling interactions among variables (5:39) <https://youtu.be/lTgffhleslw>`_

Classification
---------------

* `Screencast - Partitioning data with XLMiner (6:39) <https://youtu.be/tMMeEOMGEU0>`_
...
* `Screencast - Using LR in our credit approval problem (5:40) <https://youtu.be/30gF54p_qls>`_
